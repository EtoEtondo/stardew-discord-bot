# Marketing Checklist (Stardew Helper)
...
- [ ] top.gg listing (description, tags, privacy/ToS).
- [ ] GitHub topics: `discord-bot`, `stardew-valley`, `python`, `open-source`.
- [ ] Release with changelog + tag.

## Phase 3: Community
- [ ] Issues/Discussions triage routine.
- [ ] Good first issues + contributor guide.
- [ ] /about or /help footer links to GitHub.
- [ ] Soft outreach: helpful posts in relevant communities (no spam).

## Phase 4: Growth Features
- [ ] Daily/weekly value (fun facts, quiz leaderboards).
- [ ] Optional seasonal reminders.
